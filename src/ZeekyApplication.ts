...
import { ConfigService, ContextManager, FeatureRegistry, IntentRouter, AIManager, AppLifecycleManager } from '@/services';
...
container.register<ContextManager>(ContextManager, { useClass: ContextManager });
container.register<FeatureRegistry>(FeatureRegistry, { useClass: FeatureRegistry });
...
container.register<AppLifecycleManager>(AppLifecycleManager, { useClass: AppLifecycleManager });

// Register lifecycle services
container.register<ILifecycleService>('ILifecycleService', { useClass: AIManager });
